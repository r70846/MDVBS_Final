...
-(NSMutableDictionary*)getDefaultTags{
    ...
    [valueArray removeAllObjects];
    [valueArray addObject:@"_standard"];
    [valueArray addObject:@"40 Beats Per Minute"];
    [valueArray addObject:@"50 Beats Per Minute"];
    [valueArray addObject:@"60 Beats Per Minute"];
    [valueArray addObject:@"70 Beats Per Minute"];
    [valueArray addObject:@"80 Beats Per Minute"];
    [valueArray addObject:@"90 Beats Per Minute"];
